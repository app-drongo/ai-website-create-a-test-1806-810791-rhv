...
export default function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      title: 'Compliance',
      links: [
        { name: 'Privacy Protection', href: '/privacy' },
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              <p className="text-muted-foreground text-sm leading-relaxed mb-6">
                ...
                industry leaders who rely on our comprehensive platform for strategic
                decision-making.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">
                Receive weekly analytics insights and platform updates. Unsubscribe anytime.
              </p>
            </div>
          </div>
